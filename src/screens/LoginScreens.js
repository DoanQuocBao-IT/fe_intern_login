...
const LoginScreens = () => {
  ...
  // Đăng nhập bằng Google API
  const clientId = "455442902148-h3q556ghk05ff09h0qi7mudh6g0rf45i.apps.googleusercontent.com";
  function onSuccess(response) {
    console.log("Login success", response);
    const { accessToken, refreshToken } = response.tokenId;
    setAccessToken(accessToken);
    setRefreshToken(refreshToken);
    navigate("/loginsuccess");
  }
    ...
    <div
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        <Form
            ...
            <GoogleLogin
              ...
              render={(renderProps) => (
                <Button
                  ...
                  style={{ width: "100%" }}
                  icon={
                    <GooglePlusOutlined size="large" style={{ fontSize: "16px", color: "red" }} />
                  }>
                  Sign in Google
                </Button>
              )}
          ...
          <Form.Item>
            <Button type="primary" size="large" style={{ width: "100%" }} onClick={handleLogin}>
              Sign in
            </Button>
          </Form.Item>
